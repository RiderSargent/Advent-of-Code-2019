...
fn test_day_2_intcode_1() {
    ...
    assert_eq!(expected, intcode::run_program(input, program).0);
}
...
fn test_day_5_intcode_1() {
    ...
    assert_eq!(expected, intcode::run_program(input, program).1);
}
...
fn test_day_5_intcode_4() {
    ...
    assert_eq!(vec![1], intcode::run_program(vec![8], program.clone()).1);
    assert_eq!(vec![0], intcode::run_program(vec![3], program.clone()).1);
}
...
fn test_day_5_intcode_6() {
    ...
    assert_eq!(vec![1], intcode::run_program(vec![7], program.clone()).1);
    assert_eq!(vec![0], intcode::run_program(vec![9], program.clone()).1);
}
...
fn test_day_5_intcode_8() {
    ...
    assert_eq!(vec![1], intcode::run_program(vec![7], program.clone()).1);
    assert_eq!(vec![0], intcode::run_program(vec![0], program.clone()).1);
}
...
fn test_day_5_intcode_10() {
    ...
    assert_eq!(vec![999], intcode::run_program(vec![7], program.clone()).1);
    assert_eq!(vec![1000], intcode::run_program(vec![8], program.clone()).1);
    assert_eq!(vec![1001], intcode::run_program(vec![10], program.clone()).1);
}
